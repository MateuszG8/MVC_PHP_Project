        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav p-2 me-auto">
                <li class="nav-item dropdown">
                    <a class="nav-link" href="#" id="navbarDropdown1" role="button" data-bs-toggle="dropdown" aria-expanded="false"><?php echo "Witaj, ".$_SESSION['imie']?></a>
                    <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="../Model/mojeprzepisy.php">Moje przepisy</a></li>
                        <li><a class="dropdown-item" href="../Model/dodajprzepis.php">Dodaj przepis</a></li>
                        <li><a class="dropdown-item" href="../Model/logout.php">Wyloguj</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
